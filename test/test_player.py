import unittest
import sys
sys.path.insert(0, 'c:\\Users\\a\\Desktop\\training-on-testing\\war-card-game-examination2-sustainableProgramming')
...
class TestPlayer(unittest.TestCase):
    ...
    def setUp(self):
        self.player1 = Player("player1", 1, "0", "0", "0.0")
        self.player2 = Player("player2", 2, "0", "0", "0.0")
    ...
    def test_create_deck_diamonds(self):
        test_diamonds = [["diamonds", 1], ["diamonds", 2], ["diamonds", 3],
                         ...
                         ["diamonds", 13]]
        self.assertEqual(Player.create_deck_diamonds(self), test_diamonds)
    ...
    def test_create_deck_hearts(self):
        test_hearts = [["hearts", 1], ["hearts", 2], ["hearts", 3],
                       ...
                       ["hearts", 10], ["hearts", 11], ["hearts", 12],
                       ["hearts", 13]]
        self.assertEqual(Player.create_deck_hearts(self), test_hearts)
    ...
    def test_create_deck_spades(self):
        test_spades = [["spades", 1], ["spades", 2], ["spades", 3],
                       ...
                       ["spades", 13]]
        self.assertEqual(Player.create_deck_spades(self), test_spades)
    ...
    def test_count_cards(self):
        self.assertEqual(self.player1.count_cards(), 26)
        self.assertEqual(self.player2.count_cards(), 26)
